...
ggplot(completion_rates, aes(x = reorder(Department, Completed),
                             ...
                             fill=Completed)) +
  geom_col() +
  geom_text(nudge_y = 0.024, color = "black")+
...
ggsurvfit(R_surv_fit, type= "risk", linewidth = 1.75, color="purple3")+
  geom_vline(xintercept = 33,linewidth = 2, linetype = "dashed", color = "orange")+
...
Responded_To <- c("clb46@uw.edu","calhounk@uw.edu", "schiang@uw.edu","sinadada@uw.edu","tbdodson@uw.edu", "rge@uw.edu", "ellint@uw.edu", "bgoff@uw.edu", 	"jihuang@uw.edu", "karik3@uw.edu", "meyertk@uw.edu", "krismoe@uw.edu", 	"lowens2@uw.edu", "chrismp@uw.edu", "scriba@uw.edu", "ashope@uw.edu","elisej@uw.edu", "lazeck@uw.edu")
